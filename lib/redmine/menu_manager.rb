  ...
  module MenuManager
    ...
    module MenuHelper
      ...
      def extract_node_details(node, project=nil)
        ...
        if item.name.to_s=='projects' && curl=='/projects'
          selected=true
        end
        if item.name.to_s=='my_page' && curl=='/'
          selected=true
        end
        if item.name.to_s=='administration' && curl=='/admin'
          selected=true
        end
        return [caption, url, (current_menu_item == item.name || selected)]
      end
